...
`Candango` is the project identity: a builder-oriented workflow for coordinating planning, design, issue slicing, testing, validation, and execution into one feature worksite.
