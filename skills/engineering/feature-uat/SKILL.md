---
name: feature-uat
description: Generate user acceptance tests from business definitions, feature plans, technical specs, and issue acceptance criteria. Use when the user wants UAT scenarios before implementation, during validation, or before marking autonomous feature work done.
---
...
Candango role: acceptance definition layer. Defines business-visible proof that the feature should work.
