...
Use `grill-with-docs` first when business definitions, domain terms, or validation expectations are ambiguous.

Use `huashu-design` before finalizing the spec when the business definition includes interface scope and the user wants layouts/screens created or edited.
...
- UI conventions
- design artifacts from `huashu-design`, Figma, screenshots, or existing UI
- tests and CI
