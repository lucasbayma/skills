---
name: candango-tdd
description: Candango TDD. Test-driven development with red-green-refactor for autonomous feature execution. Use when implementing feature issues, fixing validator findings, writing behavior tests, building vertical slices, or when candango-executor delegates an issue to an executor subagent. Requires one behavior at a time, public-interface tests, minimal implementation, and candango-caveman user-facing reports. Fork credit to Matt Pocock tdd.
---

# Candango TDD

Use `$candango-caveman` for every user-facing update and final report.
