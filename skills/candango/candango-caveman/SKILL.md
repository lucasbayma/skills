---
name: candango-caveman
description: Candango Caveman. Mandatory ultra-compressed communication mode for all user-facing messages and written reports in this skill repo, including technical work, feature planning, specs, issue breakdowns, UATs, autonomous execution logs, dashboard history, validator reports, and status updates. Use when user says candango-caveman mode, caveman mode, less tokens, be brief, or when any feature workflow communicates with the user. Fork credit to the local caveman skill and Matt Pocock concise communication workflow inspiration.
---
